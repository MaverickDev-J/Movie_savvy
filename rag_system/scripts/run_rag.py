...
# from rag_system.functions.context_optimizer import ContextOptimizer
...
# # Initialize generator and function manager
# generator = None
...
#         if content_results.get("web_results"):
#             web_context = content_results["web_results"]
#             logger.info(f"Retrieved {len(web_context)} web results")
...
#                 # Extract transcript chunks for context
#                 transcript_chunks = video_data.get("transcript_chunks", [])
#                 youtube_context.extend([chunk.get("text", "") for chunk in transcript_chunks])
