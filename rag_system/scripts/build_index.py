...
#         # Update metadata with index_id for chunks
#         chunk_to_item = {}
#         with open(CHUNKS_FILE, 'r', encoding='utf-8') as f:
#             for line in tqdm(f, desc="Mapping chunks to items"):
#                 chunk = json.loads(line.strip())
#                 chunk_to_item[chunk['id']] = chunk['metadata']['item_id']
...
#             item['index_ids'] = []
#             for chunk_id, index_id in chunk_to_index.items():
#                 if chunk_to_item.get(chunk_id) == item_id:
#                     item['index_ids'].append(index_id)
